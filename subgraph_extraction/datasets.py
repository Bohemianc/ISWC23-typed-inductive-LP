...
def generate_subgraph_datasets(params, splits=['train', 'valid'], saved_relation2id=None, max_label_value=None):
    ...
    for split_name, split in graphs.items():
        ...
        with open(f'{params.main_dir}/../data/{params.dataset}/{split_name}_neg.pkl', 'wb') as f:
            pickle.dump(split['neg'], f)
...
class SubgraphDataset(Dataset):
    ...
    def __init__(self, db_path, db_name_pos, db_name_neg, raw_data_paths, included_relations=None, add_traspose_rels=False, num_neg_samples_per_link=1):
        ...
        ssp_graph, triplets, entity2id, relation2id, id2entity, id2relation = process_files(raw_data_paths, included_relations)
    ...
    def _prepare_subgraphs(self, nodes, r_label, n_labels):
        ...
        subgraph = self._prepare_features_new(subgraph, n_labels, nodes)
    ...
    def _prepare_features_new(self, subgraph, n_labels, nodes):
        # One hot encode the node label feature and concat to n_featsure
        n_nodes = subgraph.number_of_nodes()
